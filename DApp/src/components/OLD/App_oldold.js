...
class App extends Component {
  ...
  createRequest(memeHash) {
    this.setState({ loading: true })
    this.state.contract.methods.createRequest(this.state.account, result[0].hash).send({ from: this.state.account })
  ...
  //    this.state.contract.methods.createRequest(this.state.account, result[0].hash).send({ from: this.state.account }).then((r) => { return this.setState({ loading: false }) })
